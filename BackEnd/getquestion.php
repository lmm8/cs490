...
// get questions for  grading script
...
$question1 = $mysqli->query("SELECT Question FROM TestQuestions WHERE QID = '$QID1'");
...
$question2 = $mysqli->query("SELECT Question FROM TestQuestions WHERE QID = '$QID2'");
...
$question3 = $mysqli->query("SELECT Question FROM TestQuestions WHERE QID = '$QID3'");
