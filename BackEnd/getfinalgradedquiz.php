...
//get the graded and released quiz from the DB
...
$score1 = $mysqli->query("SELECT Score1 FROM TakenTests WHERE QuizID = '$QuizID' AND Status = 'R'");
$score1row = mysqli_fetch_object($score1);
array_push($send,$score1row);

$points1 = $mysqli->query("SELECT Points1 FROM Tests WHERE QuizID = '$QuizID' AND Status = 'R'");
$points1row = mysqli_fetch_object($points1);
array_push($send,$points1row);

$comment1 = $mysqli->query("SELECT Comment1 FROM TakenTests WHERE QuizID = '$QuizID' AND Status = 'R'");
...
$score2 = $mysqli->query("SELECT Score2 FROM TakenTests WHERE QuizID = '$QuizID' AND Status = 'R'");
$score2row = mysqli_fetch_object($score2);
array_push($send,$score2row);

$points2 = $mysqli->query("SELECT Points2 FROM Tests WHERE QuizID = '$QuizID' AND Status = 'R'");
$points2row = mysqli_fetch_object($points2);
array_push($send,$points2row);

$comment2 = $mysqli->query("SELECT Comment2 FROM TakenTests WHERE QuizID = '$QuizID' AND Status = 'R'");
...
$score3 = $mysqli->query("SELECT Score3 FROM TakenTests WHERE QuizID = '$QuizID' AND Status = 'R'");
$score3row = mysqli_fetch_object($score3);
array_push($send,$score3row);

$points3 = $mysqli->query("SELECT Points3 FROM Tests WHERE QuizID = '$QuizID' AND Status = 'R'");
$points3row = mysqli_fetch_object($points3);
array_push($send,$points3row);

$comment3 = $mysqli->query("SELECT Comment3 FROM TakenTests WHERE QuizID = '$QuizID' AND Status = 'R'");
$comment3row = mysqli_fetch_object($comment3);
array_push($send,$comment3row);

$teachercomment = $mysqli->query("SELECT Teacher_Comment FROM TakenTests WHERE QuizID = '$QuizID' AND Status = 'R'");
$teachercommentrow = mysqli_fetch_object($teachercomment);
array_push($send,$teachercommentrow);
